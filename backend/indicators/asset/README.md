...
## func [RegisterRepositoryBuilder](<https://indicator/blob/master/asset/repository_factory.go#L33>)
...
## func [SnapshotsAsClosings](<https://indicator/blob/master/asset/snapshot.go#L79>)
...
## func [SnapshotsAsDates](<https://indicator/blob/master/asset/snapshot.go#L43>)
...
## func [SnapshotsAsHighs](<https://indicator/blob/master/asset/snapshot.go#L61>)
...
## func [SnapshotsAsLows](<https://indicator/blob/master/asset/snapshot.go#L70>)
...
## func [SnapshotsAsOpenings](<https://indicator/blob/master/asset/snapshot.go#L52>)
...
## func [SnapshotsAsVolumes](<https://indicator/blob/master/asset/snapshot.go#L88>)
...
## type [FileSystemRepository](<https://indicator/blob/master/asset/file_system_repository.go#L20-L26>)
...
### func [NewFileSystemRepository](<https://indicator/blob/master/asset/file_system_repository.go#L30>)
...
### func \(\*FileSystemRepository\) [Append](<https://indicator/blob/master/asset/file_system_repository.go#L96>)
...
### func \(\*FileSystemRepository\) [Assets](<https://indicator/blob/master/asset/file_system_repository.go#L38>)
...
### func \(\*FileSystemRepository\) [Get](<https://indicator/blob/master/asset/file_system_repository.go#L60>)
...
### func \(\*FileSystemRepository\) [GetSince](<https://indicator/blob/master/asset/file_system_repository.go#L65>)
...
### func \(\*FileSystemRepository\) [LastDate](<https://indicator/blob/master/asset/file_system_repository.go#L79>)
...
## type [InMemoryRepository](<https://indicator/blob/master/asset/in_memory_repository.go#L15-L18>)
...
### func [NewInMemoryRepository](<https://indicator/blob/master/asset/in_memory_repository.go#L21>)
...
### func \(\*InMemoryRepository\) [Append](<https://indicator/blob/master/asset/in_memory_repository.go#L79>)
...
### func \(\*InMemoryRepository\) [Assets](<https://indicator/blob/master/asset/in_memory_repository.go#L28>)
...
### func \(\*InMemoryRepository\) [Get](<https://indicator/blob/master/asset/in_memory_repository.go#L38>)
...
### func \(\*InMemoryRepository\) [GetSince](<https://indicator/blob/master/asset/in_memory_repository.go#L48>)
...
### func \(\*InMemoryRepository\) [LastDate](<https://indicator/blob/master/asset/in_memory_repository.go#L62>)
...
<a name="Repository"></a>
## type [Repository](<https://indicator/blob/master/asset/repository.go#L20-L39>)
...
### func [NewRepository](<https://indicator/blob/master/asset/repository_factory.go#L38>)
...
## type [RepositoryBuilderFunc](<https://indicator/blob/master/asset/repository_factory.go#L23>)
...
## type [SQLRepository](<https://indicator/blob/master/asset/sql_repository.go#L17-L35>)
...
### func [NewSQLRepository](<https://indicator/blob/master/asset/sql_repository.go#L38>)
...
### func \(\*SQLRepository\) [Append](<https://indicator/blob/master/asset/sql_repository.go#L170>)
...
### func \(\*SQLRepository\) [Assets](<https://indicator/blob/master/asset/sql_repository.go#L87>)
...
### func \(\*SQLRepository\) [Close](<https://indicator/blob/master/asset/sql_repository.go#L82>)
...
### func \(\*SQLRepository\) [Drop](<https://indicator/blob/master/asset/sql_repository.go#L193>)
...
### func \(\*SQLRepository\) [Get](<https://indicator/blob/master/asset/sql_repository.go#L112>)
...
### func \(\*SQLRepository\) [GetSince](<https://indicator/blob/master/asset/sql_repository.go#L117>)
...
### func \(\*SQLRepository\) [LastDate](<https://indicator/blob/master/asset/sql_repository.go#L152>)
...
## type [SQLRepositoryDialect](<https://indicator/blob/master/asset/sql_repository_dialect.go#L8-L26>)
...
<a name="Snapshot"></a>
## type [Snapshot](<https://indicator/blob/master/asset/snapshot.go#L15-L38>)
...
<a name="Sync"></a>
## type [Sync](<https://indicator/blob/master/asset/sync.go#L25-L38>)
...
<a name="NewSync"></a>
### func [NewSync](<https://indicator/blob/master/asset/sync.go#L41>)
...
<a name="Sync.Run"></a>
### func \(\*Sync\) [Run](<https://indicator/blob/master/asset/sync.go#L51>)
...
## type [TiingoEndOfDay](<https://indicator/blob/master/asset/tiingo_repository.go#L41-L80>)
...
### func \(\*TiingoEndOfDay\) [ToSnapshot](<https://indicator/blob/master/asset/tiingo_repository.go#L83>)
...
<a name="TiingoMeta"></a>
## type [TiingoMeta](<https://indicator/blob/master/asset/tiingo_repository.go#L19-L37>)
...
## type [TiingoRepository](<https://indicator/blob/master/asset/tiingo_repository.go#L98-L112>)
...
### func [NewTiingoRepository](<https://indicator/blob/master/asset/tiingo_repository.go#L116>)
...
### func \(\*TiingoRepository\) [Append](<https://indicator/blob/master/asset/tiingo_repository.go#L238>)
...
### func \(\*TiingoRepository\) [Assets](<https://indicator/blob/master/asset/tiingo_repository.go#L126>)
...
### func \(\*TiingoRepository\) [Get](<https://indicator/blob/master/asset/tiingo_repository.go#L131>)
...
### func \(\*TiingoRepository\) [GetSince](<https://indicator/blob/master/asset/tiingo_repository.go#L136>)
...
### func \(\*TiingoRepository\) [LastDate](<https://indicator/blob/master/asset/tiingo_repository.go#L198>)
