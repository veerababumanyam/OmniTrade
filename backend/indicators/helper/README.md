...
<a name="Abs"></a>
## func [Abs](<https://indicator/blob/master/helper/abs.go#L15>)
...
<a name="Add"></a>
## func [Add](<https://indicator/blob/master/helper/add.go#L18>)
...
## func [AppendOrWriteToCsvFile](<https://indicator/blob/master/helper/csv.go#L323>)
...
<a name="Apply"></a>
## func [Apply](<https://indicator/blob/master/helper/apply.go#L17>)
...
<a name="Buffered"></a>
## func [Buffered](<https://indicator/blob/master/helper/buffered.go#L12>)
...
<a name="ChanToJSON"></a>
## func [ChanToJSON](<https://indicator/blob/master/helper/chan_to_json.go#L23>)
...
## func [ChanToSlice](<https://indicator/blob/master/helper/chan_to_slice.go#L19>)
...
<a name="Change"></a>
## func [Change](<https://indicator/blob/master/helper/change.go#L14>)
...
## func [ChangePercent](<https://indicator/blob/master/helper/change_percent.go#L15>)
...
## func [ChangeRatio](<https://indicator/blob/master/helper/change_ratio.go#L15>)
...
## func [CheckEquals](<https://indicator/blob/master/helper/check.go#L14>)
...
## func [CloseAndLogError](<https://indicator/blob/master/helper/closer.go#L13>)
...
## func [CloseAndLogErrorWithLogger](<https://indicator/blob/master/helper/closer.go#L18>)
...
## func [CloseDatabaseRows](<https://indicator/blob/master/helper/database.go#L31>)
...
## func [CloseDatabaseWithError](<https://indicator/blob/master/helper/database.go#L14>)
...
## func [CommonPeriod](<https://indicator/blob/master/helper/sync.go#L24>)
...
<a name="Count"></a>
## func [Count](<https://indicator/blob/master/helper/count.go#L25>)
...
## func [DaysBetween](<https://indicator/blob/master/helper/days_between.go#L13>)
...
## func [DecrementBy](<https://indicator/blob/master/helper/decrement_by.go#L16>)
...
<a name="Divide"></a>
## func [Divide](<https://indicator/blob/master/helper/divide.go#L20>)
...
<a name="DivideBy"></a>
## func [DivideBy](<https://indicator/blob/master/helper/divide_by.go#L15>)
...
<a name="Drain"></a>
## func [Drain](<https://indicator/blob/master/helper/drain.go#L8>)
...
<a name="Duplicate"></a>
## func [Duplicate](<https://indicator/blob/master/helper/duplicate.go#L17>)
...
<a name="Echo"></a>
## func [Echo](<https://indicator/blob/master/helper/echo.go#L14>)
...
<a name="Field"></a>
## func [Field](<https://indicator/blob/master/helper/field.go#L14>)
...
<a name="Filter"></a>
## func [Filter](<https://indicator/blob/master/helper/filter.go#L17>)
...
<a name="First"></a>
## func [First](<https://indicator/blob/master/helper/first.go#L8>)
...
<a name="Gcd"></a>
## func [Gcd](<https://indicator/blob/master/helper/gcd.go#L8>)
...
<a name="Head"></a>
## func [Head](<https://indicator/blob/master/helper/head.go#L16>)
...
<a name="Highest"></a>
## func [Highest](<https://indicator/blob/master/helper/highest.go#L11>)
...
## func [IncrementBy](<https://indicator/blob/master/helper/increment_by.go#L16>)
...
<a name="JSONToChan"></a>
## func [JSONToChan](<https://indicator/blob/master/helper/json_to_chan.go#L14>)
...
## func [JSONToChanWithLogger](<https://indicator/blob/master/helper/json_to_chan.go#L19>)
...
## func [KeepNegatives](<https://indicator/blob/master/helper/keep_negatives.go#L15>)
...
## func [KeepPositives](<https://indicator/blob/master/helper/keep_positives.go#L15>)
...
<a name="Last"></a>
## func [Last](<https://indicator/blob/master/helper/last.go#L8>)
...
<a name="Lcm"></a>
## func [Lcm](<https://indicator/blob/master/helper/lcm.go#L8>)
...
<a name="Lowest"></a>
## func [Lowest](<https://indicator/blob/master/helper/Lowest.go#L11>)
...
<a name="Map"></a>
## func [Map](<https://indicator/blob/master/helper/map.go#L17>)
...
## func [MapWithPrevious](<https://indicator/blob/master/helper/map_with_previous.go#L17>)
...
<a name="MaxSince"></a>
## func [MaxSince](<https://indicator/blob/master/helper/max_since.go#L14>)
...
<a name="MinSince"></a>
## func [MinSince](<https://indicator/blob/master/helper/min_since.go#L13>)
...
<a name="Multiply"></a>
## func [Multiply](<https://indicator/blob/master/helper/multiply.go#L20>)
...
<a name="MultiplyBy"></a>
## func [MultiplyBy](<https://indicator/blob/master/helper/multiply_by.go#L16>)
...
<a name="Operate"></a>
## func [Operate](<https://indicator/blob/master/helper/operate.go#L15>)
...
<a name="Operate3"></a>
## func [Operate3](<https://indicator/blob/master/helper/operate3.go#L15>)
...
<a name="Operate4"></a>
## func [Operate4](<https://indicator/blob/master/helper/operate4.go#L15>)
...
<a name="Operate5"></a>
## func [Operate5](<https://indicator/blob/master/helper/operate5.go#L15-L22>)
...
## func [PercentRank](<https://indicator/blob/master/helper/percent_rank.go#L12>)
...
<a name="Pipe"></a>
## func [Pipe](<https://indicator/blob/master/helper/pipe.go#L16>)
...
<a name="Pow"></a>
## func [Pow](<https://indicator/blob/master/helper/pow.go#L17>)
...
## func [ReadFromCsvFile](<https://indicator/blob/master/helper/csv.go#L310>)
...
<a name="Remove"></a>
## func [Remove](<https://indicator/blob/master/helper/remove.go#L13>)
...
<a name="RemoveAll"></a>
## func [RemoveAll](<https://indicator/blob/master/helper/remove.go#L23>)
...
<a name="RoundDigit"></a>
## func [RoundDigit](<https://indicator/blob/master/helper/round_digit.go#L15>)
...
## func [RoundDigits](<https://indicator/blob/master/helper/round_digits.go#L15>)
...
<a name="Seq"></a>
## func [Seq](<https://indicator/blob/master/helper/seq.go#L21>)
...
<a name="Shift"></a>
## func [Shift](<https://indicator/blob/master/helper/shift.go#L15>)
...
<a name="Sign"></a>
## func [Sign](<https://indicator/blob/master/helper/sign.go#L15>)
...
<a name="Since"></a>
## func [Since](<https://indicator/blob/master/helper/since.go#L9>)
...
<a name="Skip"></a>
## func [Skip](<https://indicator/blob/master/helper/skip.go#L15>)
...
<a name="SkipLast"></a>
## func [SkipLast](<https://indicator/blob/master/helper/skip_last.go#L11>)
...
## func [SliceToChan](<https://indicator/blob/master/helper/slice_to_chan.go#L17>)
...
## func [SlicesReverse](<https://indicator/blob/master/helper/slices_reverse.go#L6>)
...
## func [SortedPercentRank](<https://indicator/blob/master/helper/percent_rank.go#L55>)
...
<a name="Sqrt"></a>
## func [Sqrt](<https://indicator/blob/master/helper/sqrt.go#L16>)
...
<a name="Subtract"></a>
## func [Subtract](<https://indicator/blob/master/helper/subtract.go#L17>)
...
<a name="SyncPeriod"></a>
## func [SyncPeriod](<https://indicator/blob/master/helper/sync.go#L29>)
...
<a name="Waitable"></a>
## func [Waitable](<https://indicator/blob/master/helper/waitable.go#L11>)
...
<a name="Window"></a>
## func [Window](<https://indicator/blob/master/helper/window.go#L12>)
...
<a name="Bst"></a>
## type [Bst](<https://indicator/blob/master/helper/bst.go#L15-L17>)
...
<a name="NewBst"></a>
### func [NewBst](<https://indicator/blob/master/helper/bst.go#L20>)
...
### func \(\*Bst\[T\]\) [Contains](<https://indicator/blob/master/helper/bst.go#L57>)
...
### func \(\*Bst\[T\]\) [Insert](<https://indicator/blob/master/helper/bst.go#L25>)
...
<a name="Bst[T].Max"></a>
### func \(\*Bst\[T\]\) [Max](<https://indicator/blob/master/helper/bst.go#L85>)
...
<a name="Bst[T].Min"></a>
### func \(\*Bst\[T\]\) [Min](<https://indicator/blob/master/helper/bst.go#L75>)
...
### func \(\*Bst\[T\]\) [Remove](<https://indicator/blob/master/helper/bst.go#L64>)
...
<a name="BstNode"></a>
## type [BstNode](<https://indicator/blob/master/helper/bst.go#L8-L12>)
...
<a name="Csv"></a>
## type [Csv](<https://indicator/blob/master/helper/csv.go#L40-L53>)
...
<a name="NewCsv"></a>
### func [NewCsv](<https://indicator/blob/master/helper/csv.go#L80>)
...
### func \(\*Csv\[T\]\) [AppendToFile](<https://indicator/blob/master/helper/csv.go#L206>)
...
### func \(\*Csv\[T\]\) [ReadFromFile](<https://indicator/blob/master/helper/csv.go#L182>)
...
### func \(\*Csv\[T\]\) [ReadFromReader](<https://indicator/blob/master/helper/csv.go#L127>)
...
### func \(\*Csv\[T\]\) [WriteToFile](<https://indicator/blob/master/helper/csv.go#L222>)
...
<a name="CsvOption"></a>
## type [CsvOption](<https://indicator/blob/master/helper/csv.go#L56>)
...
### func [WithCsvDefaultDateTimeFormat](<https://indicator/blob/master/helper/csv.go#L73>)
...
### func [WithCsvLogger](<https://indicator/blob/master/helper/csv.go#L66>)
...
### func [WithoutCsvHeader](<https://indicator/blob/master/helper/csv.go#L59>)
...
<a name="Float"></a>
## type [Float](<https://indicator/blob/master/helper/helper.go#L27-L29>)
...
<a name="Integer"></a>
## type [Integer](<https://indicator/blob/master/helper/helper.go#L22-L24>)
...
<a name="Number"></a>
## type [Number](<https://indicator/blob/master/helper/helper.go#L32-L34>)
...
<a name="Report"></a>
## type [Report](<https://indicator/blob/master/helper/report.go#L48-L55>)
...
<a name="NewReport"></a>
### func [NewReport](<https://indicator/blob/master/helper/report.go#L60>)
...
### func \(\*Report\) [AddChart](<https://indicator/blob/master/helper/report.go#L76>)
...
### func \(\*Report\) [AddColumn](<https://indicator/blob/master/helper/report.go#L83>)
...
### func \(\*Report\) [WriteToFile](<https://indicator/blob/master/helper/report.go#L111>)
...
### func \(\*Report\) [WriteToWriter](<https://indicator/blob/master/helper/report.go#L99>)
...
## type [ReportColumn](<https://indicator/blob/master/helper/report.go#L28-L40>)
...
### func [NewAnnotationReportColumn](<https://indicator/blob/master/helper/annotation_report_column.go#L16>)
...
### func [NewNumericReportColumn](<https://indicator/blob/master/helper/numeric_report_column.go#L17>)
...
<a name="Ring"></a>
## type [Ring](<https://indicator/blob/master/helper/ring.go#L18-L23>)
...
<a name="NewRing"></a>
### func [NewRing](<https://indicator/blob/master/helper/ring.go#L26>)
...
<a name="Ring[T].At"></a>
### func \(\*Ring\[T\]\) [At](<https://indicator/blob/master/helper/ring.go#L71>)
...
<a name="Ring[T].Get"></a>
### func \(\*Ring\[T\]\) [Get](<https://indicator/blob/master/helper/ring.go#L53>)
...
### func \(\*Ring\[T\]\) [IsEmpty](<https://indicator/blob/master/helper/ring.go#L76>)
...
### func \(\*Ring\[T\]\) [IsFull](<https://indicator/blob/master/helper/ring.go#L81>)
...
<a name="Ring[T].Put"></a>
### func \(\*Ring\[T\]\) [Put](<https://indicator/blob/master/helper/ring.go#L37>)
